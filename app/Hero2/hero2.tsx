    ...
    <div className='flex flex-col lg:flex-row lg:gap-44 justify-center pt-9 bg-[#fefbf5]'>
        ...
        <div className='py-3 px-12'>
            ...
            <div className='flex flex-col gap-10 lg:flex-row pt-10'>
                ...
                <p className='lg:w-[200px] pt-4'>by selecting your country and instantly
                ...
                <h2 className='text-xl font-semibold pt-5'>Fund your wallet</h2>
                <p className='lg:w-[200px] pt-4'>via multiple channels 
                ...
                <h2 className='text-xl font-semibold pt-5'>Start Investing</h2>
                <p className='lg:w-[200px] pt-4'>in your favorite public listed US company, a bundle 
