...
const HeroPage = () => {
  return (
    <div className="lg:py-20 px-5 lg:px-60">
    ...
    <div className='relative bottom-44 lg:bottom-[800px] lg:px-14 px-4'>
      ...
      <button className='bg-[#e6ff55] text-green-700 py- px-2 lg:p-7 lg:px-12 rounded-xl lg:text-4xl lg:mt-20 mt-5'> Start investing</button>
    </div>
  </div>
